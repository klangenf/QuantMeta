...
PATH=/home/klangenf/anaconda/envs/ ###Update to user specific anaconda environment path
snakemake --profile Config --latency-wait 300 --use-conda --conda-prefix $PATH --conda-frontend mamba --snakefile Snakefile-quant_targets
