...
# Logs
#SBATCH --mail-user=klangenf@umich.edu ###Update to be user specific
...
snakemake --profile Config --latency-wait 300 --use-conda --conda-prefix $PATH --conda-frontend mamba --snakefile Snakefile-map_standards
