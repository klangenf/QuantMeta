...
def main():
    ...
    parser.add_argument('--spike-in-info', '-spike', default=None, help='Table of sample-specific spike-in information (Sample, Library_Mass (ng), DNA_Extract_Conc (ng/µL), Spike_Frac, ssDNA (0/Spike_Frac) (default: None, required)')
