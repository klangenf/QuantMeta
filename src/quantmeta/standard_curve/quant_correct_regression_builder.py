...
def main():
    ...
    output_rdv = Path(f'{out_dir}/Regressions/read_depth_variability')
    output_rdv.mkdir(parents=True, exist_ok=True)
    output_trdv = Path(f'{out_dir}/Regressions/threshold_read_depth_variability')
    ...
    print(f"✅ Quantification correction regression building complete for project. Please check Q-Q plots and RMSE thresholds to ensure they are appropriate for your data. Adjust regression terms or bin thresholds as needed and re-run if necessary.")
