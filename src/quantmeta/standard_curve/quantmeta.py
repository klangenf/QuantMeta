...
def detection_threshold(sample_name, mapping_results_path, target_length_df, detect_thresh, out_dir):
    ...
    output_path = Path(f'{out_dir}/Mapping/{sample_name}/standards_mapping_analysis.txt')
...
def visualize(sample_name, results, out_dir):
    ...
    output_path = Path(f'{out_dir}/Regressions/quantification/{sample_name}_standards_rel_to_abs.png')
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def quantmeta(sample_name,
    ...
    reg_name = Path(f'{out_dir}/Regressions/quantification/{sample_name}_rel_to_abs.pkl')
...
def main():
    ...
    for _, row in sample_info.iterrows():
        ...
        output = Path(f'{out_dir}/Regressions/quantification/{sample_name}_quantmeta_results.txt')
