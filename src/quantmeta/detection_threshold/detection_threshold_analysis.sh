...
python3 ${9}/../organize_mapping.py -d ${8}/tmp/${sample}/standards_depth.txt -f $3 -o ${8}/Mapping/${sample}_100/standards_mapping.txt
...
for downsample in 1 10; do
    ...
    python3 ${9}/../organize_mapping.py -d ${8}/tmp/${sample}_${downsample}/standards_depth.txt -f $3 -o ${8}/Mapping/${sample}_${downsample}/standards_mapping.txt
done
...
for fail_set in r1 r2 r3 r4 r5; do
    ...
    python3 ${9}/../organize_mapping.py -d ${8}/tmp/${sample}/fail_standards_${fail_set}_depth.txt -f ${8}/Map_Indexes/fail_standards_${fail_set}/fail_standards_ms.fasta -o ${8}/Mapping/${sample}/fail_standards_${fail_set}_mapping.txt
done

### Map reads to test database
samtools depth -a -H ${7}/${sample}_${4}_sorted.bam --reference $5 > ${8}/tmp/${sample}/${4}_depth.txt
python3 ${9}/../organize_mapping.py -d ${8}/tmp/${sample}/${4}_depth.txt -f $5 -o ${8}/Mapping/${sample}/${4}_mapping.txt
