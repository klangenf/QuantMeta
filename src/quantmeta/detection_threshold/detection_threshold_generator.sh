...
mkdir -p ${output_dir}/Map_Indexes/fail_standards_r1
mkdir -p ${output_dir}/Map_Indexes/fail_standards_r2
mkdir -p ${output_dir}/Map_Indexes/fail_standards_r3
mkdir -p ${output_dir}/Map_Indexes/fail_standards_r4
mkdir -p ${output_dir}/Map_Indexes/fail_standards_r5
...
python3 ${BASE_DIR}/confident_detection_regression_builder.py --sample-file $config --std-file $mix --ssDNA-std-file $ssmix --min-coverage $min_coverage --min-distribution $min_distribution --test-database $test_name --output-dir $output_dir