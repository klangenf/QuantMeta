...
def quant_correct_analysis(sample_name, descript, mapping_results, results,quad_reg1_path, 
    ...
    if results[results['ID'] == ID]['RMSE'].iloc[0] > results[results['ID'] == ID]['RMSE_limit'].iloc[0]:
        results[results['ID'] == ID]['status'] = 'needs_correction'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--detect-thresh', required=True, help='Path to detection threshold')
    parser.add_argument('--quad-reg1', required=True, help='Path to read depth variability model for 0-10 reads/bp')
    parser.add_argument('--quad-reg2', required=True, help='Path to read depth variability model for 10-100 reads/bp')
    parser.add_argument('--quad-reg3', required=True, help='Path to read depth variability model for 100-1000 reads/bp')
    parser.add_argument('--quad-reg4', required=True, help='Path to read depth variability model for 1000+ reads/bp')
    parser.add_argument('--cutoff-function1', required=True, help='Paths to RMSE threshold function for 0-10 reads/bp')
    parser.add_argument('--cutoff-function2', required=True, help='Paths to RMSE threshold function for 10-100 reads/bp')
    parser.add_argument('--cutoff-function3', required=True, help='Paths to RMSE threshold function for 100-1000 reads/bp')
    parser.add_argument('--cutoff-function4', required=True, help='Paths to RMSE threshold function for 1000+ reads/bp')
